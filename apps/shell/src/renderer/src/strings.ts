...
export const strings = {
  zh: {
    ...
    onbNote3: 'AI 功能使用你配置的服务商——默认是本地 Ollama 模型，也可以使用你自己的 API Key。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    onbCredits: 'Active contributors get early access to new features',
    ...
    onbNote3: 'AI features run on the provider you configure — a local Ollama model by default, or your own API key.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    onbCredits: 'アクティブな貢献者は新機能に早期アクセスできます',
    ...
    onbNote3: 'AI 機能は設定したプロバイダーで動作します。デフォルトはローカルの Ollama モデルで、独自の API キーも使用できます。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    onbCredits: '활발한 기여자는 신기능을 먼저 사용할 수 있습니다',
    ...
    onbNote3: 'AI 기능은 설정한 공급자에서 실행됩니다. 기본값은 로컬 Ollama 모델이며, 직접 API 키를 사용할 수도 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    loginCopied: 'Copié',
    loginNetworkError: 'Impossible de joindre Codex — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    onbCredits: 'Les contributeurs actifs ont un accès anticipé aux nouvelles fonctionnalités',
    ...
    onbNote3: 'Les fonctions IA s\'exécutent via le fournisseur que vous configurez — un modèle Ollama local par défaut, ou votre propre clé API.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    onbCredits: 'Aktive Mitwirkende erhalten frühzeitigen Zugang zu neuen Funktionen',
    ...
    onbNote3: 'KI-Funktionen laufen über den von Ihnen konfigurierten Anbieter – standardmäßig ein lokales Ollama-Modell oder Ihr eigener API-Schlüssel.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    loginCopied: 'Copiado',
    loginNetworkError: 'No se puede conectar con Codex — compruebe su red o la configuración del proxy',
    ...
    onbCredits: 'Los colaboradores activos obtienen acceso anticipado a las nuevas funciones',
    ...
    onbNote3: 'Las funciones de IA se ejecutan con el proveedor que configures: un modelo Ollama local de forma predeterminada, o tu propia clave de API.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้ทดลองใช้ฟีเจอร์ใหม่ก่อนใคร',
    ...
    onbNote3: 'ฟีเจอร์ AI ทำงานผ่านผู้ให้บริการที่คุณตั้งค่า — ค่าเริ่มต้นคือโมเดล Ollama ในเครื่อง หรือใช้ API Key ของคุณเอง',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    loginCopied: 'Disalin',
    loginNetworkError: 'Tidak dapat terhubung ke Codex — periksa jaringan atau pengaturan proxy Anda',
    ...
    onbCredits: 'Kontributor aktif mendapatkan akses awal ke fitur baru',
    ...
    onbNote3: 'Fitur AI berjalan melalui penyedia yang Anda konfigurasi — model Ollama lokal secara default, atau kunci API Anda sendiri.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    onbCredits: 'Активные участники получают ранний доступ к новым функциям',
    ...
    onbNote3: 'Функции ИИ работают через настроенного вами провайдера — по умолчанию локальная модель Ollama, либо ваш собственный API-ключ.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    onbCredits: 'يحصل المساهمون النشطون على وصول مبكر إلى الميزات الجديدة',
    ...
    onbNote3: 'تعمل ميزات الذكاء الاصطناعي عبر المزوّد الذي تقوم بتكوينه — نموذج Ollama محلي افتراضيًا، أو مفتاح API الخاص بك.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    account: 'Conta',
    login: 'Entrar',
    loginCodex: 'Entrar com o Codex',
    loggedIn: 'Conectado',
    loggedInCodex: 'Conectado ao Codex',
    ...
    loginCopied: 'Copiado',
    loginNetworkError: 'Não é possível conectar ao Codex — verifique sua rede ou configurações de proxy',
    ...
    onbCredits: 'Contribuidores ativos têm acesso antecipado a novos recursos',
    ...
    onbNote3: 'Os recursos de IA são executados no provedor que você configurar — um modelo Ollama local por padrão, ou sua própria chave de API.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    loggedInCodex: 'Accesso a Codex effettuato',
    ...
    loginCopied: 'Copiato',
    loginNetworkError: 'Impossibile raggiungere Codex — controlla la rete o le impostazioni proxy',
    ...
    onbCredits: 'I contributori attivi ottengono accesso anticipato alle nuove funzionalità',
    ...
    onbNote3: 'Le funzionalità IA vengono eseguite tramite il provider configurato — un modello Ollama locale per impostazione predefinita, oppure una tua chiave API.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    onbCredits: 'Aktywni współtwórcy uzyskują wczesny dostęp do nowych funkcji',
    ...
    onbNote3: 'Funkcje AI działają w oparciu o skonfigurowanego dostawcę — domyślnie lokalny model Ollama lub Twój własny klucz API.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginCodex: 'Aanmelden met Codex',
    loggedIn: 'Ingelogd',
    loggedInCodex: 'Aangemeld bij Codex',
    ...
    loginNetworkError: 'Kan geen verbinding maken met Codex — controleer je netwerk- of proxy-instellingen',
    ...
    onbCredits: 'Actieve bijdragers krijgen vroege toegang tot nieuwe functies',
    ...
    onbNote3: 'AI-functies draaien via de door jou geconfigureerde provider — standaard een lokaal Ollama-model, of je eigen API-sleutel.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    loggedInCodex: 'Sudah log masuk ke Codex',
    ...
    onbCredits: 'Penyumbang aktif mendapat akses awal kepada ciri baharu',
    ...
    onbNote3: 'Ciri AI berjalan melalui penyedia yang anda konfigurasikan — model Ollama tempatan secara lalai, atau kunci API anda sendiri.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-Codex — בדוק את הרשת או הגדרות הפרוקסי',
    ...
    onbCredits: 'תורמים פעילים מקבלים גישה מוקדמת לתכונות חדשות',
    ...
    onbNote3: 'תכונות ה-AI פועלות דרך הספק שהגדרת — מודל Ollama מקומי כברירת מחדל, או מפתח API משלך.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    account: 'खाता',
    login: 'साइन इन करें',
    loginCodex: 'Codex से लॉगिन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInCodex: 'Codex में लॉगिन हो गया',
    waitingLogin:
    ...
    loginNetworkError: 'Codex से कनेक्ट नहीं हो सका — कृपया अपना नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    onbCredits: 'सक्रिय योगदानकर्ताओं को नई सुविधाओं तक जल्दी पहुँच मिलती है',
    ...
    onbNote3: 'AI सुविधाएँ आपके द्वारा कॉन्फ़िगर किए गए प्रदाता पर चलती हैं — डिफ़ॉल्ट रूप से एक स्थानीय Ollama मॉडल, या आपकी अपनी API कुंजी।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線 Codex，請檢查網路或代理伺服器設定',
    ...
    onbNote3: 'AI 功能使用您設定的服務商——預設為本機 Ollama 模型，也可使用您自己的 API 金鑰。',
    onbBack: '上一步',
  },
} as const
