...
export function registerAiIpc(): void {
  ...
  // Codex CLI account (`codex login` state): auth source for the search/image-gen/media
  // tools; the frontend uses it to prompt login when those tools are unavailable
  ipcMain.handle(
    'ai:codex-status',
